    ...
    <div class="page">
        <form action="Accueil.php" method="post">
            ...
            <?php
                ...
                $T_ac = isset($_POST["T_a"])? $_POST["T_a"] : "";
                $T_bc = isset($_POST["T_b"])? $_POST["T_b"] : "";
                $V_ac = isset($_POST["V_a"])? $_POST["V_a"] : "";
                $V_bc = isset($_POST["V_b"])? $_POST["V_b"] : "";
                $T_af= ($T_ac*(9/5)+32);
                $T_bf= ($T_bc*(9/5)+32);
                $V_am= ($V_ac*0.000001);
                $V_bm= ($V_bc*0.000001);
                $API_Grav = isset($_POST["API_Grav"])? $_POST["API_Grav"] : "";
                ...
                $sql = "INSERT INTO fluid_data_oil (Name_fluid,Densite_API,TempA_F,TempA_C,Va_cst,Va_m,TempB_F,TempB_C,Vb_cst,Vb_m) VALUES ('$nom','$API_Grav','$T_af','$T_ac','$V_ac','$V_am','$T_bf','$T_bc','$V_bc','$V_bm')";
